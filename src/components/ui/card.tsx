...
/**
 * Otzar floating card — Behance bright enterprise surface by default.
 * Soft light shadow, white pearl face, brand-ink type.
 */
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "otzar-glass-card otzar-edge-trace text-card-foreground",
      className,
    )}
    {...props}
  />
