...
function stateClasses(state: ActivationStep["state"]): string {
  switch (state) {
    ...
    case "current":
      return "border-[#B124E8]/35 bg-[#B124E8]/10 text-[#1e1b4b] ring-1 ring-[#B124E8]/25 shadow-[0_8px_20px_-10px_rgba(177,36,232,0.3)]";
    case "needs_attention":
      return "border-[#F77737]/35 bg-[#F77737]/10 text-[#1e1b4b]";
    case "unknown":
    default:
      return "border-[#1e1b4b]/08 bg-white/80 text-[#1e1b4b]";
  }
}
...
export function SetupActivationPath({
  ...
  return (
    <Card data-testid="setup-activation-path" className="otzar-atari-frame rounded-[1.5rem]">
      ...
      <CardContent className="space-y-3">
        ...
        <div
          className="flex flex-col gap-2 rounded-2xl border border-[#B124E8]/20 bg-gradient-to-r from-[#B124E8]/08 to-white p-4 shadow-[0_10px_28px_-14px_rgba(177,36,232,0.28)] sm:flex-row sm:items-center sm:justify-between"
