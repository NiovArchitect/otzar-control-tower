...
export const VOICE_SURFACES: readonly VoiceSurface[] = [
  ...
  },
  {
    ...
    aliases: ["tool connections", "connector health", "check google calendar", "connectors", "which tools are connected", "which connectors are missing"],
    admin_only: true,
    kind: "READ",
    ack: "Here's your tool connection status.",
  },
  {
    surface_id: "production_readiness",
    label: "Launch readiness",
    route: "/onboarding",
    aliases: ["launch readiness", "what is blocking launch", "launch blockers", "what is blocking production", "production blockers", "production readiness", "what can i demo today", "transaction readiness", "make a transaction", "regulator package status", "risky ai permissions"],
    admin_only: true,
    kind: "READ",
