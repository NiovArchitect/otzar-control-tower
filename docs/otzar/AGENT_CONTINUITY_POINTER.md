...
**Next internal Work OS priority:** R-03 **BOUNDED** (live ~200 + S250 sim; S2500 FOUNDER_DEFERRED). Prefer browser/product coherence on sim tenant — do not escalate live identity count.
