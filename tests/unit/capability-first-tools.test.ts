...
describe("O-01 capability-first tools contract", () => {
  ...
  it("admin default tab is OAuth Connections; advanced is last", () => {
    expect(DEFAULT_ADMIN_TOOLS_TAB).toBe("connections");
    expect(ADMIN_TOOLS_TAB_ORDER[0]).toBe("connections");
